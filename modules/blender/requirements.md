...
| **Launcher** | `uvx --from "git+https://projects.blender.org/lab/blender_mcp@4309a39646e644261624bfcd2bca669b343b7621#subdirectory=mcp" blender-mcp` (server package is in the repo's `mcp/` subdir) |
